const NewsLetter = () => {
    return (
        <div
            className="h-[40vh] flex items-center justify-center  mx-0 md:mx-4 lg:mx-0"
            style={{
                backgroundImage:
        ...
        >
            ...
            >
                ...
                <div className="mt-5 flex justify-center">
                    <input
                        type="email"
                        className="pl-4 w-[200px] lg:w-[400px] border h-10 lg:h-14 focus:outline-none rounded-l-lg bg-white border-slate-400"
